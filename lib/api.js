...
var validateCookie = function validateCookie(callback, error) {
  (0, _axios.default)("".concat(HOST, "/must-be-authed"), {
    method: "get",
...
var validateLogin = function validateLogin(data) {
  return _axios.default.post("".concat(HOST, "/login"), data).then(function (res) {
    return res;
