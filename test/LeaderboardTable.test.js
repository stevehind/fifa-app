...
it("renders leaderhboard data", () => {
    const tableData: TableObjectList = [
        {
          "Richard": {
    ...
    //TODO: loop over the dummy data, and use it to check cell by cell what the content is in the table that is rendered
    expect(container?.getElementsByTagName("table")[0].rows[0].cells[0].textContent).toBe("Name");
});